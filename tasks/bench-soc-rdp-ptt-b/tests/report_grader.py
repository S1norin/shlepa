#!/usr/bin/env python3
"""Grader for bench-soc-rdp-ptt-b (SOCBench SCN-036, adapted).
...
Reads /app/report.json and exits 0 iff:
  ...
  compromised_hosts          normalizes to exactly {'db-srv-01'}
  compromised_accounts       normalizes to exactly {'r.chen'}
  key_indicators             >= 2 strings, each appearing verbatim in the
                             evidence, with >= 2 distinct hits in
                             3389, 10.10.3.236, 10.10.5.41
...
REQUIRED_HOSTS = {'db-srv-01'}
REQUIRED_ACCOUNTS = {'r.chen'}
IOC_KEYWORDS = {'10.10.3.236', '10.10.5.41', '3389'}
