#!/usr/bin/env python3
"""Grader for SOCBench ransomware pre-deployment task.

Reads /app/report.json and exits 0 iff:

  verdict                    == TRUE_POSITIVE_INCIDENT
  primary_mitre_technique    contains T1490
  compromised_hosts          normalizes to exactly {'ws-acct-05'}
  ...
  key_indicators             >= 2 strings, each appearing verbatim in the
                             ...
                             vssadmin, syscheck.exe, SystemHealthCheck
...
REQUIRED_MITRE = ['T1490']
REQUIRED_HOSTS = {'ws-acct-05'}
REQUIRED_ACCOUNTS = {'j.doe'}
IOC_KEYWORDS = {'vssadmin', 'syscheck.exe', 'systemhealthcheck'}
