#!/usr/bin/env python3
"""Grader for bench-soc-https-beacon-a (SOCBench SCN-027, adapted).
...
Reads /app/report.json and exits 0 iff:
  ...
  compromised_hosts          normalizes to exactly {'ws-hr-04'}
  compromised_accounts       normalizes to exactly {'p.adams'}
...
REQUIRED_HOSTS = {'ws-hr-04'}
REQUIRED_ACCOUNTS = {'p.adams'}
