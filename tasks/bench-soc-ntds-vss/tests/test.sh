#!/usr/bin/env bash
# Verifier for bench-soc-ntds-vss (SOCBench SCN-012, adapted).
#
# The agent's /app/report.json is graded field-by-field by
# report_grader.py (verdict taxonomy per SOCBench: TP / authorized-pentest
# FP / benign anomaly, plus attribution and IOC checks). Reward 1 iff all
