#!/usr/bin/env python3
"""Grader for bench-soc-https-beacon-b (SOCBench SCN-047, adapted).

Reads /app/report.json and exits 0 iff:

  verdict                    == TRUE_POSITIVE_INCIDENT
  primary_mitre_technique    contains one of T1071.001, T1573.002
  compromised_hosts          normalizes to exactly {'ws-eng-09'}
...
REQUIRED_MITRE = ['T1071.001', 'T1573.002']
REQUIRED_HOSTS = {'ws-eng-09'}
REQUIRED_ACCOUNTS = {'m.jones'}
IOC_KEYWORDS = {'198.51.100.47', '443'}
