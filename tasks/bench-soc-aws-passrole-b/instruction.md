# SOC ticket AL-3043 — CloudTrail IAM anomaly (2026-04-22)

The `cloudtrail-iam-anomaly` rule fired around 09:00-09:10 UTC on 2026-04-22. The exported telemetry for the surrounding window (07:00-13:00 UTC) is attached. You are the analyst on duty.
...
- `aws_cloudtrail.jsonl` — AWS CloudTrail export for the window (one JSON object per event).
