#!/usr/bin/env python3
"""Grader for bench-soc-aws-passrole-b (SOCBench SCN-043, adapted).
...
Reads /app/report.json and exits 0 iff:
  ...
  compromised_hosts          normalizes to exactly {'ws-eng-04'}
  ...
  key_indicators             >= 2 strings, each appearing verbatim in the
                             ...
                             passrole, adminrole, 91.108.4.22, python-requests
...
REQUIRED_HOSTS = {'ws-eng-04'}
REQUIRED_ACCOUNTS = {'r.chen'}
IOC_KEYWORDS = {'91.108.4.22', 'adminrole', 'passrole', 'python-requests'}
