#!/usr/bin/env python3
"""Grader for bench-soc-amsi-bypass-b (SOCBench SCN-042, adapted).

Reads /app/report.json and exits 0 iff:

  verdict                    == TRUE_POSITIVE_INCIDENT
  primary_mitre_technique    contains one of T1562.001
  compromised_hosts          normalizes to exactly {'ws-fin-02'}
...
REQUIRED_MITRE = ['T1562.001']
REQUIRED_HOSTS = {'ws-fin-02'}
REQUIRED_ACCOUNTS = {'e.taylor'}
IOC_KEYWORDS = {'0x1410', 'amsi', 'powershell'}
