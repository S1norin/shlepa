#!/usr/bin/env python3
"""Grader for bench-soc-ntds-vss-b (SOCBench SCN-052, adapted).

Reads /app/report.json and exits 0 iff:

  verdict                    == TRUE_POSITIVE_INCIDENT
  primary_mitre_technique    contains one of T1003.003
...
IOC_KEYWORDS = {'harddiskvolumeshadowcopy', 'ntds.dit', 'vssadmin'}
