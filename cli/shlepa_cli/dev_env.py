...
def parse_agent_metrics(stderr: str) -> dict:
    ...
    crash). Cache fields default to 0 for legacy markers.
    """
    defaults = {
        "final_output": "",
        "tokens_in": 0,
